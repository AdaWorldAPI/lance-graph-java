...
value record RowRange(long start, long endExclusive) {
    RowRange {
...
value record MaskId(long token) {
...
value record Ordinal(int value) {
    Ordinal {
 ...
 */
value record Row(long id, int cls, int value) {}
